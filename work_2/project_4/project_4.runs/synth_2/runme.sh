...
HD_PWD='C:/Users/htqwj/APCU/work_2/project_4/project_4.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log AC701.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AC701.tcl
