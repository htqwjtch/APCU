...
set_property PACKAGE_PIN F25 [get_ports ledboard]
set_property IOSTANDARD LVCMOS25 [get_ports ledboard]
...
set_property PACKAGE_PIN U5 [get_ports pushbuttons[1]]
set_property IOSTANDARD SSTL15 [get_ports pushbuttons[1]]
set_property PACKAGE_PIN T5 [get_ports pushbuttons[2]]
set_property IOSTANDARD SSTL15 [get_ports pushbuttons[2]]
set_property PACKAGE_PIN R5 [get_ports pushbuttons[3]]
