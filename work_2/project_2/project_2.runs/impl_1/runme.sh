...
HD_PWD='C:/Users/htqwj/APCU/work_2/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dd_trigger.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dd_trigger.tcl -notrace
