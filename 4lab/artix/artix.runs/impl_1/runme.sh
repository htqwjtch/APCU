...
HD_PWD='D:/4/APCU/4lab/artix/artix.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log artix.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source artix.tcl -notrace
