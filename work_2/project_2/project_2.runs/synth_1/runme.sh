...
HD_PWD='C:/Users/htqwj/APCU/work_2/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dd_trigger.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dd_trigger.tcl
