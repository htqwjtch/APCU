...
HD_PWD='C:/Users/htqwj/APCU/work_1/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_d.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encoder_d.tcl
