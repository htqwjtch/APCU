...
HD_PWD='C:/Users/htqwj/APCU/work_2/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log d_trigger.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source d_trigger.tcl -notrace
