...
HD_PWD='C:/Users/htqwj/APCU/work_1/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_d.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source encoder_d.tcl -notrace
